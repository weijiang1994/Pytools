...
"color: rgb(255, 255, 255);")
        ...
        self.listWidget.setStyleSheet("font: 14pt \"Arial\";")
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "PIP工具"))
        item = self.listWidget.item(1)
        item.setText(_translate("MainWindow", "SQL工具"))
        item = self.listWidget.item(2)
        item.setText(_translate("MainWindow", "TCP工具"))
